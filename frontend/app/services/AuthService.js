...
export default class AuthService {
    ...
    static createUser(username, password) {
        return ApiCallerService.postNoAuth('authuser/signup', {'username': username, 'password': password})
            .then(res => res.json())
            .then(res=> {sessionStorage.setItem(USER_NAME_SESSION_ATTRIBUTE_NAME, JSON.stringify(res))})
            .then(res => {
                return res;
    ...
    static createGame() {
        return ApiCallerService.post('authuser/game/hostGame')
            .then(res => res.json())
    ...
    static authGame(gameCode, username) {
        ...
        return ApiCallerService.postNoAuth('gameuser/game/joinGame', {username: username, code: gameCode})
            .then(res => res.json())
            .then(res => {sessionStorage.setItem(USER_NAME_TEMP_SESSION_ATTRIBUTE_NAME, JSON.stringify(res))})
            .then(res => res)
    }
